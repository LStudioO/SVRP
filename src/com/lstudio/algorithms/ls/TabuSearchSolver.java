...
public class TabuSearchSolver {
    ...
    public TabuSearchSolver(int tabuHorizon, double[][] distances, int[] startDepots,
                            HashMap<Integer, Integer> endDepots, int iterations) {
        this.noOfVehicles = startDepots.length;
        this.TABU_Horizon = tabuHorizon;
        this.distances = distances;
        this.iterations = iterations;

        int vehicleCapacity = 1000;

        GreedySolver greedySolver = new GreedySolver(startDepots, endDepots, distances.length, noOfVehicles,
        ...
        for (int i = 0; i < this.noOfVehicles; i++) {
            this.BestSolutionVehicles[i] = new Vehicle(vehicleCapacity);
        }
    }
